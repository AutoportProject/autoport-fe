...
GitHub 연동 흐름, 포트폴리오 수정/공유/내보내기 화면, 프론트엔드 상태 관리와 API 연동을 담당했습니다.
...
#### AI 포트폴리오 생성 프롬프트 엔지니어링
- 저장소 분석 데이터를 반영한 프롬프트 설계
- 설명, 주요 기능, 기술적 기여 등 항목 간 역할 분리로 중복 방지
- 안정적인 JSON 출력을 위한 형식 규칙 적용
- 번역투 지양, 무주어 사용 등 한국어 출력 품질 개선
